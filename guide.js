...
const ShogiGuide=(()=>{
  // 初心者が対局中に最もよく聞く呼び方。正式名ではなく、連盟も案内する略称を優先する。
  const readings={1:'ふ',2:'きょうしゃ',3:'けいま',4:'ぎん',5:'きん',6:'かく',7:'ひしゃ',8:'ぎょく',9:'ときん',10:'なりきょう',11:'なりけい',12:'なりぎん',14:'うま',15:'りゅう'};
  const displayNames={1:'歩',2:'香車',3:'桂馬',4:'銀',5:'金',6:'角',7:'飛車',8:'玉',9:'と金',10:'成香',11:'成桂',12:'成銀',14:'馬',15:'龍'};
